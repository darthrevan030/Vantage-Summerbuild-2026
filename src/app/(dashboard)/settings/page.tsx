...
export default function SettingsPage() {
  ...
  const previewWordmark = nameInput.trim()
    ? `${nameInput.trim()}'s Portfolio`
    : "PORTFOLIO";
    ...
    <div className="flex flex-col gap-4.5 min-w-0 w-full">
      <div className="mb-1 animate-reveal">
        <div>
          ...
          <h2 className="font-serif font-normal text-[28px] m-0 text-primary">
            Preferences
          </h2>
          <p
      ...
      <form
        onSubmit={handleSave}
        className="flex flex-col gap-4.5 animate-reveal"
      ...
      >
        ...
        <div className="card flex flex-col gap-4 px-5 py-4.5 max-bp480:p-3.5 max-bp380:p-3">
          <div className="flex items-baseline justify-between mb-4">
            ...
            <span className="font-ui text-secondary text-[11px]">
              shown in the top-left wordmark
            </span>
          </div>
          ...
          <div className="flex items-center gap-3 mt-1.5 px-3.5 py-2.5 bg-elevated border border-subtle rounded-[10px]">
            ...
            <span className="font-serif font-normal text-[18px] text-gold tracking-[.3px] [text-shadow:0_0_14px_var(--accent-glow)]">
              {previewWordmark}
            </span>
          </div>
        </div>
        ...
        <div className="card flex flex-col gap-4 px-5 py-4.5 max-bp480:p-3.5 max-bp380:p-3">
          <div className="flex items-baseline justify-between mb-4">
            ...
            <span className="font-ui text-secondary text-[11px]">
              all portfolio totals convert to this currency
            </span>
          </div>
