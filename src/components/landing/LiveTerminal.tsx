...
const TREND = [
  34, 38, 36, 42, 40, 46, 44, 52, 49, 57, 54, 62, 58, 66, 71, 68, 76, 74, 82,
  88, 85, 94, 91, 104,
];
const HOLDINGS = [
  {
  ...
  },
  {
    ...
    pct: "−0.4%",
    up: false,
    pts: [5, 4.8, 5.2, 4.6, 4.9, 4.4, 4.6, 4.3],
  },
  {
    ticker: "BTC",
    name: "Bitcoin",
    ...
    pct: "+3.1%",
    up: true,
    pts: [2, 2.6, 2.2, 3, 3.4, 3.1, 3.9, 4.6],
  },
  {
    ticker: "XAU",
    name: "Gold (spot)",
    ...
    pct: "+0.6%",
    up: true,
    pts: [4, 4.2, 4.1, 4.4, 4.3, 4.6, 4.5, 4.8],
  },
];
...
export function LiveTerminal() {
  ...
  return (
    <div
      ref={wrapRef}
      aria-hidden
      className="mx-auto max-w-[920px] [perspective:1400px]"
        ...
        <div className="flex flex-wrap items-end justify-between gap-4 border-b border-subtle px-6 py-5">
          ...
          <div className="flex gap-7 max-bp480:gap-5">
            <div>
              ...
              <div className="mt-1 font-mono text-[15px] font-semibold tabular-nums text-fx-up">
                +S$12,480
              </div>
            </div>
            <div>
              ...
              <div className="mt-1 font-mono text-[15px] font-semibold tabular-nums text-primary">
                24
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center p-3">
            {HOLDINGS.map((h, i) => (
              ...
              >
                ...
                <span
                  className={
                    "w-12 text-right font-mono text-[11.5px] font-semibold tabular-nums " +
                    (h.up ? "text-gain" : "text-loss")
                  }
                >
                  {h.pct}
                </span>
